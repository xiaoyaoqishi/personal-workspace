...
export const listAssetValuations = (assetId) => apiClient.get(`/ledger/assets/${assetId}/valuations`)
export const createAssetValuation = (assetId, payload) => apiClient.post(`/ledger/assets/${assetId}/valuations`, payload)
