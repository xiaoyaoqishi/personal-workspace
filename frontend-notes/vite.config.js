...
function manualChunks(id) {
  ...
  if (path.includes('/lowlight/') || path.includes('/highlight.js/')) return 'editor-syntax-vendor'
  if (path.includes('/tiptap-markdown/')) return 'markdown-vendor'
  ...
  if (path.includes('/axios/') || path.includes('/dayjs/') || path.includes('/lunar-javascript/')) return 'utils-vendor'
}
