...
router.get("/trades/exchange-rate/usd-cny")(trade_service.get_usd_cny_exchange_rate)
...
router.get("/trades/{trade_id:int}/research-documents")(research_service.list_trade_research_documents)
